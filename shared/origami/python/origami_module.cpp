...
NB_MODULE(origami, m)
{
    ...
    m.def("int_to_reduction_t",
          &origami::int_to_reduction_t,
          "Convert int to reduction_t.");
    ...
    nanobind::class_<origami::problem_t>(m, "problem_t")
        ...
        .def_rw("transpose_a", &origami::problem_t::transpose_a)
        .def_rw("transpose_b", &origami::problem_t::transpose_b)
        ...
        .def_rw("mx_block_size", &origami::problem_t::mx_block_size);
    ...
    nanobind::class_<hardware_t>(m, "hardware_t")
        ...
        .def("extract_analytical_metrics_json", &hardware_t::extract_analytical_metrics_json)
    ...
    m.def("select_config", &origami::select_config, "Select best configuration based on problem and hardware");
    m.def("select_grid_size", &origami::select_grid_size, "Select best grid size for the given configuration");
    m.def("select_workgroup_mapping", &origami::select_workgroup_mapping, "Select best workgroup mapping");
    m.def("rank_configs", &origami::rank_configs, "Rank configurations by performance");
    m.def("select_config_mnk", &origami::select_config_mnk, "Select best configuration for M,N,K dimensions");
    ...
    m.def("compute_total_latency", 
          static_cast<double (*)(const origami::hardware_t&, const origami::problem_t&, const origami::config_t&, std::size_t)>(&origami::compute_total_latency), 
          "Compute total latency");
    
    // Analytical metrics extraction functions
    m.def("extract_analytical_metrics", &origami::extract_analytical_metrics, 
          "Extract analytical metrics from GEMM computation");
    m.def("extract_analytical_metrics_csv", &origami::extract_analytical_metrics_csv,
